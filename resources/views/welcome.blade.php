...
<body class="">
    ...
    <header class="h-screen flex justify-center lg:justify-between md:overflow-hidden">
        <div class="hidden lg:block w-[35%] relative">  
                <div
                class="absolute bg-[#A60606] w-[600px] lg:w-[700px] xl:w-[800px] 2xl:w-[860px] h-[1200px] rounded-[100px] rotate-[32deg] outline outline-[16px] outline-[#FFE366] left-[-490px] xl:left-[-380px] overflow-hidden">
        ...
        <div class="flex-col w-full content-center justify-items-center space-y-4 md:w-[60%] xl:w-[50%]">
